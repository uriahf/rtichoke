...
(() => {
  ...
  function poll() {
    ...
    if (doc) {
      ...
      const smoothCalibration = component("calibration")?.querySelector("svg");
      ...
      if (table && ppcrTable && smoothCalibration && precisionRecall && decisionCurve && interventionsAvoided && cssLoaded && styled) {
        status.dataset.ready = "true";
        status.dataset.table = "true";
        status.dataset.ppcrTable = "true";
        status.dataset.smoothCalibration = "true";
