# Recipes & Canonical Workflows

This page serves as a compact, authoritative recipe guide for data
scientists and automated coding agents using `rtichoke` in R.
...
Compare multiple models evaluated on identical subjects and outcomes
using a named list.
...
Compare one model across distinct cohorts (e.g., Train vs. Test split or
demographic groups).
...
Generate a single interactive HTML file containing all evaluations and
performance tables.
