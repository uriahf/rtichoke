archive <- "inst/rtichoke-viz/rtichoke-viz-0.7.0.tar.gz"
...
stopifnot(
  ...
  "commit=b3564d2824ec1791f791fda406c99b3d7865a68f" %in% manifest
)
...
message("Verified rtichoke_viz v0.7.0: ", actual)
