...
xaringanExtra::use_logo(
  image_url = "rtichoke_003_walkthrough_files/clalit_innovation_logo.jpg"
)
```
...
knitr::include_graphics("rtichoke_003_walkthrough_files/live_coding.jpg")
```
